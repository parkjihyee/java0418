package co.micol.P20220504.menu;

import java.sql.Date;
import java.util.Scanner;

import co.micol.P20220504.dto.StudentVO;
import co.micol.P20220504.service.StudentService;
public class Menu {
	...
	private void mainMenu() {
		boolean b = false; //관례적으로 초기값을 false로 둔다.
	...
	private void noticeMenu() {
		...
		switch(code) {
			case 1:
				System.out.println("전체 공지 목록을 보여준다.");
				break;
			case 2:
				System.out.println("공지 조회내역을 보여준다.");
				break;
			case 3:
				System.out.println("공지를 한 개 등록한다.");
				break;
			case 4:
				System.out.println("공지를 한 개 수정한다.");
				break;
			case 5:
				System.out.println("공지를 한 개 삭제한다.");
				break;				
			case 6:
				b = true;
				System.out.println("Good bye~~~");
