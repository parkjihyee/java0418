...
public class ArrayExam {
	...
	public static void main(String[] args) {
		...
		//2) 데이터 저장 하는 방법
		int[] ary1 = {1,2,3,4,5}; //int형으로 데이터를 만들것이라는 의미
...
//			//ary2[0] = sc.nextInt();
//			//ary2[1] = sc.nextInt(); 이 두 줄을 아래 한 줄로 표현
//			ary2[i] = sc.nextInt(); //각 배열의 첫번째~다섯번째 데이터를 넣는 구문
//			System.out.println(ary2[i]); //각 배열의 데이터 출력
//	}
		for(int i =0; i<ary2.length;i++) {
		...
		sum = 0;
		//배열의 공간을 나타낼 때 인덱스 값 : 0~99 = 100개
		for(int i=0; i<ary3.length; i++) {
			//100번째 배열 자리에 1~99에 더한 값을 저장하는 방법
			if(i == 99) {
				ary3[i] = sum;
				break;
			}
